...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      actionListItemDefaultActiveBg: "var(--color-action-list-item-default-active-bg)",
      actionListItemDangerActiveBg: "var(--color-action-list-item-danger-active-bg)",
      actionListItemDefaultSelectedBg: "var(--color-action-list-item-default-selected-bg)",
      actionListItemDangerSelectedBg: "var(--color-action-list-item-danger-selected-bg)",
