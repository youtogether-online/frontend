...
export type SendCodeFailedResponseAllOfCode =
  (typeof SendCodeFailedResponseAllOfCode)[keyof typeof SendCodeFailedResponseAllOfCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SendCodeFailedResponseAllOfCode = {
